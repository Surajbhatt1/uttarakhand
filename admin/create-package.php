...
$sql="INSERT INTO TblTourPackages(PackageCategoryId,PackageName,PackageType,PackageLocation,PackagePrice,PackageFetures,PackageDetails,PackageImage) VALUES(:PackageCategoryId,:pname,:ptype,:plocation,:pprice,:pfeatures,:pdetails,:pimage)";
...
$query->bindParam(':PackageCategoryId',$packagecat,PDO::PARAM_STR);
$query->execute();
  	         ...
  	         <div class="tab-content">
						<div class="tab-pane active" id="horizontal-form">
							<form class="form-horizontal" name="package" method="post" enctype="multipart/form-data">
								...
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Package Category</label>
									<div class="col-sm-8">
									

										<select class="form-control1" name="packagecat" id="packagecat" required>

										<option value="" disabled selected>Select Category</option>

											<?php
											$sql = "SELECT * FROM `tblpackagecategory` WHERE inactive=0";
