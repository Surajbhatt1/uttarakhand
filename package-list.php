...
if(!isset($_GET['type']) || $_GET['type']==-1){
	...
	$where = "WHERE t.PackageCategoryId = $_GET[type]";

}

$sql = "SELECT t.*,c.name from tbltourpackages t LEFT JOIN tblpackagecategory c ON t.PackageCategoryId=c.id $where";
...
{	?>
			<div class="rom-btm">
				...
				<div class="col-md-6 room-midle wow fadeInUp animated" data-wow-delay=".5s">
					...
					<h6>Package Category : <?php echo htmlentities($result->name);?></h6>
