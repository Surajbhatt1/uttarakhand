...
async function initialize() {
    // window.itemName = document.getElementById('itemName').value;
    // window.itemPrice =document.getElementById('itemPrice').value;
    let itemName = document.getElementById('itemName').value;
    let itemPrice =document.getElementById('itemPrice').value;
    let bookingId =document.getElementById('bookingId').value;
    ...
    const { id, clientSecret } = await fetch("payment_init.php", {
        ...
        body: JSON.stringify({ request_type:'create_payment_intent',itemName:itemName,itemPrice:itemPrice,bookingId:bookingId }),
    }).then((r) => r.json());
        ...
        switch (paymentIntent.status) { 
            case "succeeded":
                ...
                fetch("payment_init.php", {
                    method: "POST",
                    headers: { "Content-Type": "application/json" },
                    body: JSON.stringify({ request_type:'payment_insert', payment_intent: paymentIntent, customer_id: customerID,itemName:itemName,itemPrice:itemPrice,bookingId:bookingId }),
                })
