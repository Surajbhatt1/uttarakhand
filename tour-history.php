...
$sql = "SELECT tblbooking.payment_id,payment_status,paid_amount
,tblbooking.BookingId as bookid,tblbooking.PackageId as pkgid,tbltourpackages.PackageName as packagename,tblbooking.FromDate as fromdate,tblbooking.ToDate as todate,tblbooking.Comment as comment,tblbooking.status as status,tblbooking.RegDate as regdate,tblbooking.CancelledBy as cancelby,tblbooking.UpdationDate as upddate from tblbooking join tbltourpackages on tbltourpackages.PackageId=tblbooking.PackageId LEFT JOIN transactions tr ON tr.id=tblbooking.payment_id where UserEmail=:uemail";
$query = $dbh->prepare($sql);
