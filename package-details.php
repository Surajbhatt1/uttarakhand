...
if(isset($_POST['submit2']))
{
	...
	if(($_POST['fromdate']<$_POST['todate']) || ($_POST['fromdate']==$_POST['todate'])){
...
$lastInsertIdEncoded =  base64_encode($lastInsertId);
header("Location: payment_gateway.php?encoded_id=$lastInsertIdEncoded"); 
...
$error="Todate should be less than from date";
